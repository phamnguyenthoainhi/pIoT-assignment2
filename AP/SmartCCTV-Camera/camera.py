...
for file in os.listdir("/home/pi/Desktop/Assignment_2/SmartCCTV-Camera/profiles"):
    try:
        #Extracting person name from the image filename eg: david.jpg
        known_person.append(file.replace(".jpg", ""))
        file=os.path.join("/home/pi/Desktop/Assignment_2/SmartCCTV-Camera/profiles/", file)
